...
import com.cioinfotech.cychat.BuildConfig.outboundSessionKeySharingStrategy
...
import com.cioinfotech.cychat.features.command.ParsedCommand
...
class RoomDetailViewModel @AssistedInject constructor(
    ...
    init {
        ...
        if (OutboundSessionKeySharingStrategy.WhenEnteringRoom == outboundSessionKeySharingStrategy && room.isEncrypted()) {
...
//                }
    ...
    private fun handleComposerFocusChange(action: RoomDetailAction.ComposerFocusChange) {
        ...
        if (OutboundSessionKeySharingStrategy.WhenTyping == outboundSessionKeySharingStrategy && room.isEncrypted()) {
            if (action.focused) {
