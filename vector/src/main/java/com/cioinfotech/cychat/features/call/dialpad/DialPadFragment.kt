...
package com.cioinfotech.cychat.features.call.dialpad
...
class DialPadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        digits?.setTextColor(ThemeUtils.getColor(requireContext(), com.cioinfotech.cychat.R.attr.riotx_text_primary))
        ...
        if (enableDelete) {
            ...
            val tintColor = ThemeUtils.getColor(requireContext(), com.cioinfotech.cychat.R.attr.riotx_text_secondary)
