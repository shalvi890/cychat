...
package com.cioinfotech.cychat.features.home.notice.widget
...
import com.cioinfotech.cychat.databinding.MotionNoticeFabMenuMergeBinding
import com.google.android.material.floatingactionbutton.FloatingActionButton

class NoticeFabMenuView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
                                                  defStyleAttr: Int = 0) : MotionLayout(context, attrs, defStyleAttr) {

    private val views: MotionNoticeFabMenuMergeBinding

    var listener: Listener? = null

    init {
        inflate(context, R.layout.motion_notice_fab_menu_merge, this)
        views = MotionNoticeFabMenuMergeBinding.bind(this)
    }
